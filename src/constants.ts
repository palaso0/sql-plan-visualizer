...
export interface PlanNode { id: string; operation: NodeOperation; label: string; table?: string; index?: string; estimatedRows: number; inputRows?: number; estimatedCost: number; actualRows?: number; actualTime?: number; filters: string[]; extra?: string; children: PlanNode[] }
